...
<style>
    ...
    .form-floating > label { right: 0; left: auto; padding-right: 1.5rem; }
    ...
    <div class="col-lg-5 col-md-7 col-sm-10">
        ...
        <div class="card border-0 shadow-lg rounded-4">
            ...
            <div class="card-body p-4">
                <form action="<?= BASE_URL ?>/admin/seminar/create" method="POST" id="seminarForm">
                    
                    <div class="form-floating mb-4">
                        <input type="text" name="title" class="form-control" id="titleInput" placeholder="عنوان" required>
                        <label for="titleInput" class="text-muted">عنوان سمینار</label>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <!-- ویژگی مهم: autocomplete خاموش باشد -->
                        ...
                        <div class="form-text text-muted small me-2">تاریخ به صورت خودکار به فرمت استاندارد تبدیل می‌شود.</div>
                    </div>
                    ...
                    <div class="d-grid gap-2 mt-5">
                        ...
                        <a href="<?= BASE_URL ?>/admin" class="btn btn-light text-muted btn-sm mt-2">انصراف</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $('#pcal').persianDatepicker({
            ...
            persianDigit: false, // اعداد را انگلیسی می‌کند (مثلا 1404/09/05)
        ...
        // ✅ یک لایه امنیتی اضافه برای اطمینان از تبدیل اعداد فارسی به انگلیسی قبل از ارسال
        $('#seminarForm').on('submit', function() {
            var input = $('#pcal');
            var val = input.val();
            // تبدیل اعداد فارسی به انگلیسی با جاوااسکریپت
            var engVal = val.replace(/[۰-۹]/g, function(w){
